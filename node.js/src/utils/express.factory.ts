...
import * as MuroUsuarioModule from "../muro-usuario/muro-usuario.module";
import * as likeModule from "../like/like.module";
import * as newsModule from "../news/module";
import * as comentariosModule from "../comentarios/module";

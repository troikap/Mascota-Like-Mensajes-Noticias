...
export function traerPerfil(req: IReadRequest, res: express.Response) {
  Profile.findOne({
    user: req.params.userId,
    enabled: true,
  },
  function (err, profile) {
    if (err || !profile) return errorHandler.sendError(res, errorHandler.ERROR_NOT_FOUND, "No se encuentra el perfil del usuario logueado.");
...
export function fillByIdUser(req: IFindByIdRequest, res: express.Response, next: NextFunction) {
